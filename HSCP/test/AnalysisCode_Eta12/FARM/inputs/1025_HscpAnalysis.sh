...
root -l -b << EOF
   ...
   .x /eos/home-l/leyan/HSCP2024/HSCP_AN17_192/CMSSW_8_0_30/SUSYBSMAnalysis/HSCP/test/AnalysisCode_Eta12/Analysis_Step1_EventLoop.C+("ANALYSE_861_to_861", 2,  "Gluino_13TeV16G_M2000_f50")
   .q
EOF
