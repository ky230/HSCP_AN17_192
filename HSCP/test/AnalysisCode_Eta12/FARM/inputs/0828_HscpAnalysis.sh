...
root -l -b << EOF
   ...
   .x /eos/home-l/leyan/HSCP2024/HSCP_AN17_192/CMSSW_8_0_30/SUSYBSMAnalysis/HSCP/test/AnalysisCode_Eta12/Analysis_Step1_EventLoop.C+("ANALYSE_733_to_733", 0,  "Stop_13TeV16_M2200")
   .q
EOF
