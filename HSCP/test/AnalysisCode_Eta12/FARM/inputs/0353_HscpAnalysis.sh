...
root -l -b << EOF
   ...
   .x /eos/home-l/leyan/HSCP2024/HSCP_AN17_192/CMSSW_8_0_30/SUSYBSMAnalysis/HSCP/test/AnalysisCode_Eta12/Analysis_Step1_EventLoop.C+("ANALYSE_318_to_318", 2,  "Data13TeV16")
   .q
EOF
